    ...
    return (
      <div className="rounded-xl border bg-card p-6 text-center">
        ...
        <div className="mt-4 flex justify-center gap-2">
          ...
          <button
            className="rounded-lg border border-border px-4 py-2 text-sm font-medium text-foreground hover:bg-muted cursor-pointer transition-colors"
...
export function GroupCardSkeleton({
  ...
  return (
    <div className="w-full max-w-sm overflow-hidden rounded-3xl bg-card shadow-lg border border-border">
      {/* Cover */}
      <div className="relative h-40 w-full bg-muted">
        <div className="absolute inset-0 animate-pulse bg-muted" />

        {showClose && (
          <div className="absolute right-3 top-3 h-8 w-8 rounded-full bg-background/70" />
        )}
      </div>
      ...
      <div className="space-y-4 p-5">
        ...
        <div className="flex items-center gap-2">
          <div className="flex -space-x-2">
            <div className="h-8 w-8 rounded-full border-2 border-card bg-muted animate-pulse" />
            <div className="h-8 w-8 rounded-full border-2 border-card bg-muted animate-pulse" />
            <div className="h-8 w-8 rounded-full border-2 border-card bg-muted animate-pulse" />
          </div>

          <div className="flex-1 space-y-2">
            <div className="h-4 w-full max-w-55 rounded bg-muted animate-pulse" />
            <div className="h-4 w-2/3 max-w-45 rounded bg-muted animate-pulse" />
          </div>
        </div>
